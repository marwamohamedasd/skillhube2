...
@section('main')
    ...
    <div id="home" class="hero-area">
        ...
        <!-- Backgound Image -->
        <div class="bg-image bg-parallax overlay" style="background-image:url({{asset('web/img/3.png')}})"></div>
        <!-- /Backgound Image -->
        ...
        <div class="home-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="white-text">@lang('web.lionhube')</h1>
                        <p class="lead white-text">@lang('web.aricle')</p>
                        <a class="main-button icon-button" href="#">@lang('web.get start')</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="section-header text-center">
                    <h2>@lang('web.pouplar exam')</h2>
                    <p class="lead">@lang('web.atricle pouplar exams')</p>
                </div>
            </div>
            <!-- /row -->
            ...
            <div id="courses-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exams/2.png')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exams/6.png')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exams/images.jpg')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
            ...
            <div class="row">
                <div class="center-btn">
                    <a class="main-button icon-button" href="#">@lang('web.more courses btn')</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <h2 class="white-text">@lang('web.contact us btn')</h2>
                    <p class="lead white-text">@lang('web.cotact aticle')</p>
