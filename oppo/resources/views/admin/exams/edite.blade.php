...
<h3 class="card-title">edite  Exams </h3>
</div>
<!-- /.card-header -->
<!-- form start -->
...
<label >Name(en)</label>
<input type="text" class="form-control" value="{{$exam->name('en')}}"  name="name_en" >
</div>
</div>
...
<textarea  class="form-control" name="desc_en"  value="{{$exam->desc('en')}}" >  </textarea>
</div>


<div class="form-group">
<label >descriprtion(ar)</label>
<textarea  class="form-control" name="desc_ar"  value="{{$exam->desc('ar')}}"> </textarea>
...
<input type="number" class="form-control" name="diffculty" value="{{$exam->diffculty}}">
